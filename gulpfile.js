...
gulp.task('browser', function() {
  exec('browserify lib/index.js -o browser/trackrr.io-sdk-js-bundle.js -r -s GpsClientManager --external aws-iot-device-sdk -t [ babelify --presets [ es2015] ]')
});
...
gulp.task('build', 'Compiles all TypeScript source files and updates module references', function(callback) {
  gulpSequence('tslint', ['update-tsconfig', 'gen-def'], '_build'/*, 'browser'*/)(callback);
});
